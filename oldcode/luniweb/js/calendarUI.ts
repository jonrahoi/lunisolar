...
// set up / initiulize / configure the app itself - the whole gyui
function calendar() {
...
// switch between circular calendar and square layouts
...
// option here is the "what kind of religious calendar" 
// this changes the color and disposition of the text
...
//---------- create block year & button ----------
    ...
    //----- relative year AKA "what year is it in Hundu calendar?"-----
    ...
    // i don't know why there are two button handlers
...
//---------- position "what year is it?" year block & forward and back buttons ----------

    if(activeStyle === 0) { // circle calendar
...
//---------- create shape ----------
    ...
    drawCircleCalendar(circleLayer);
}

// draw the circular calendar
